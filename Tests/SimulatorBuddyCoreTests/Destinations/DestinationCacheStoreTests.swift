...
/// Tests for destination cache persistence and backward-compatible decoding.
struct DestinationCacheStoreTests {
    /// Verifies per-family cache updates preserve existing families and timestamps.
    @Test
    ...
    /// Verifies cache decoding tolerates snapshots written before Mac fields existed.
    @Test
