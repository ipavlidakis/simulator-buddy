...
/// Tests for global and scoped destination history storage.
struct HistoryStoreTests {
    /// Verifies recording a selection updates both global and scoped snapshots.
    @Test
    ...
    /// Verifies scoped history wins before falling back to global history.
    @Test
